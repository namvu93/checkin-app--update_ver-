...
const AdminSignOut = () => {
    ...
    const checkMethod = () => {
        AsyncStorage.removeItem("adminIdStore")
        AsyncStorage.removeItem("companyCodeAdminStore")
        AsyncStorage.removeItem("adminNameStore")
        AsyncStorage.removeItem("passwordAdminStore")
